...
{
    wp_register_style('hq_rental_wpv2_styles_steps_styles', plugin_dir_url( __FILE__) . 'css/hq-rental-steps.css?version=0.0.9', array(), '0.0.9' );
    ...
    wp_register_script('hq_rental_wpv2_app_init', plugin_dir_url( __FILE__) . 'js/hq-rental-app.js', array('jquery'), '0.1.6', true);
