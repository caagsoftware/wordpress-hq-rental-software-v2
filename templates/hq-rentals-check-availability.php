<?php
<form method="POST" action="https://migueltrial.caagcrm.com/car-rental/availability-check" accept-charset="UTF-8" id="availability-check-form" class="prevent-submit-by-enter AVAST_PAM_nonloginform">
