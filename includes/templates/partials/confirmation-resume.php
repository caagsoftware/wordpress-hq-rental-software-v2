                            ...
                            <div class="woocommerce-order">
                                ...
                                <ul class="woocommerce-order-overview woocommerce-thankyou-order-details order_details heading-font">
                                    <li class="woocommerce-order-overview__order order">
                                        ...
                                        <strong class="heading-font"># <?php echo $reservation->id; ?></strong>
                                    </li>
                                    <li class="woocommerce-order-overview__date date">
                                        Date:<strong><?php echo $reservation->created_at; ?></strong>
                                    </li>
                                    <li class="woocommerce-order-overview__total total">
                                        Total:<strong><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol"><?php echo $prices->outstanding_balance->amount_for_display; ?></strong>
                                    </li>
                                </ul>
