<?php
    get_header();
    wp_enqueue_style('hq_rental_wpv2_styles_availability_page');
    ?>
    <?php
        if(!empty( $_POST )){
            ?>
        <div class="container">
            ...
            foreach($cars as $car) {
                ...
                ?>
                <div class="row caag-hw-wp-availability-cars-row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="panel panel-default no-margin-bottom">
                            <div class="panel-heading text-right"
                                 style="padding-top: 1px;padding-left: 10px;padding-right: 10px;">
                                <h6>
                                    Excl. taxes &amp; insurance(s)
                                </h6>
                                <h5 style="font-size: 13px;">
                                    <a class="modal-open" data-modal_nowrap="yes" href="#"
                                       data-url="https://migueltrial.caagcrm.com/car-rental/reservations/debug-availability?vehicle_class_id=1">
